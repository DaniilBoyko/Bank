    ...
    public class BankServiceTests
    {
       /* [Test]
        public void Test_CreateNewAccount_Calls_Create_And_Commit_And_Generate()
        {
            ...
            var bankService = new AccountService(unitOfWork.Object, accountRepository.Object, generateId.Object);
        ...
        public void Test_DepositToAccount_Calls_Update_And_Commit()
        {
            ...
            var bankService = new AccountService(unitOfWork.Object, accountRepository.Object);
            bankService.CreateNewAccount("Gold", "Daniil", "Boyko");
        ...
        public void Test_CreateNewAccount_NewAccountAddedToTheRepository()
        {
            ...
            AccountService bankService = new AccountService(unitOfWork.Object, fakeAccountRepository, new Fakes.GenerateIdEasy());
